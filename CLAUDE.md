...
## Active Technologies
- TypeScript 5.x with Next.js 14 (App Router) + Next.js 14, React 18, Tailwind CSS, Gemini SDK (@google/generative-ai) (002-ai-dish-generation)
- N/A (stateless - no persistence required) (002-ai-dish-generation)
- TypeScript 5.x with Next.js 14 (App Router) + Gemini SDK (^0.21.0), React 18, Tailwind CSS (003-few-shot-prompts)
- N/A (stateless) (003-few-shot-prompts)
- TypeScript 5.x with Next.js 14 (App Router) + React 18, Tailwind CSS, Gemini SDK (^0.21.0), Lucide React (icons) (004-copy-sentence-case)
- TypeScript 5.x with Next.js 14 (App Router) + React 18, Tailwind CSS 3.4.1, Lucide React, Gemini SDK (005-ui-redesign)
...
- TypeScript 5.x with Next.js 14 (App Router) + Next.js 14, React 18, Tailwind CSS, Gemini SDK (^0.21.0) (007-api-security)
...
- TypeScript 5.x with Next.js 14 (App Router) + `next/og` (built into Next.js, no additional install needed) (009-og-social-preview)
...
## Recent Changes
- 009-og-social-preview: Added TypeScript 5.x with Next.js 14 (App Router) + `next/og` (built into Next.js, no additional install needed)
- 008-vercel-analytics: Added TypeScript 5.x with Next.js 14 (App Router) + @vercel/analytics (new), React 18, Next.js 14.2.35
- 007-api-security: Added TypeScript 5.x with Next.js 14 (App Router) + Next.js 14, React 18, Tailwind CSS, Gemini SDK (^0.21.0)
